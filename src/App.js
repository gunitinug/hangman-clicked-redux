...
class App extends Component {
  ...
  render() {
    return (
      <Game state={this.props.state} solved={this.onSetSolved} correct={this.onGuessedCorrect} wrong={this.onGuessedWrong} next={this.onPlayNext} finish={this.onFinished} />
    );
  }
}
